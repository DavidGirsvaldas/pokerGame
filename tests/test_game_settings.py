...
class DefaultGameSettingsTests(unittest.TestCase):
    ...
    def tests_get_default_setup(self):
        ...
        self.assertEqual("Player0", game_settings.players[0].name)
        self.assertEqual("Player1", game_settings.players[1].name)
        self.assertEqual("Player2", game_settings.players[2].name)
        self.assertEqual("Player3", game_settings.players[3].name)
        self.assertEqual("ConsolePlayer", game_settings.players[4].name)
