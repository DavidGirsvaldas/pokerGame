...
class DefaultGameSettingsTests(unittest.TestCase):
    ...
    def tests_get_default_setup(self):
        ...
        self.assertEqual("ConsolePlayer", game_settings.player[0].name)
        ...
        self.assertEqual(initial_stack, game_settings.player[0].stack)
        self.assertEqual(initial_stack, game_settings.player[1].stack)
        self.assertEqual(initial_stack, game_settings.player[2].stack)
        self.assertEqual(initial_stack, game_settings.player[3].stack)
        self.assertEqual(initial_stack, game_settings.player[4].stack)
